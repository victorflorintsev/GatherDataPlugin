...
public class StormedTagger {

	public String getTagged(String input) {
		final String textToTag = input;
...
//			    "</pre>\n";
		...
		final Response taggedText = StormedService.tag(textToTag, true);
		...
		String out = printResult(taggedText);
...
//		printResult(completeTagging);
	...
	private static String printResult(final Response response) {
